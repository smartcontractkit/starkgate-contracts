...
describe('ContractTestsBridge', function () {
    ...
    before(async () => { 
        ...
        let tokenBridgeFactory = await starknet.getContractFactory('./src/starkware/starknet/apps/starkgate/cairo/token_bridge.cairo')
        ...
        let ERC20Factory = await starknet.getContractFactory('./src/starkware/starknet/apps/starkgate/cairo/ERC20.cairo')
